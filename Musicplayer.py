...
def Play():
    ...
    #song=f'C:\\Users\\jaliloa\\OneDrive - Universitetet i Oslo\\Desktop\\Music Player\\{song}'
...
#Creating loot window
root = Tk()
root.title("Jalil Music Player App")
#inition mixer
mixer.init()

#create the listbox to contain songs
songs_list=Listbox(root,selectmode=SINGLE,bg="black")
songs_list.grid(columnspan=9)

#font is defined which is to be used for button 
